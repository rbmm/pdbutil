...
enum EmptyCVariant_FeatureStaging_CSD_Servicing {
	CVariant_FeatureStaging_CSD_Servicing_Empty = 0x0
};

enum EmptyCVariant_FeatureStaging_Feature_Servicing_CcWaitForCurrentLazywriterActivity {
	CVariant_FeatureStaging_Feature_Servicing_CcWaitForCurrentLazywriterActivity_Empty = 0x0
};
...
struct _CC_NUMA_NODE {
	...
	/*00c4*/ UCHAR QueueThrottle;
	/*00c8*/ LONG ThroughputTrend;
	/*00d0*/ _LARGE_INTEGER PrevRegularQueueItemRunTime;
	/*00d8*/ _LARGE_INTEGER PrevExtraWBThreadCheckTime;
	/*00e0*/ UCHAR AddExtraWriteBehindThreads;
	/*00e1*/ UCHAR RemoveExtraThreadPending;
	/*00e8*/ _LIST_ENTRY * IdleAsyncReadWorkerThreadList;
	/*00f0*/ ULONG * NumberActiveAsyncReadWorkerThreads;
	/*00f8*/ ULONG * NumberActiveCompleteAsyncReadWorkItems;
	/*0100*/ _LIST_ENTRY * AsyncReadWorkQueue;
	/*0108*/ _LIST_ENTRY * AsyncReadCompletionWorkQueue;
	/*0110*/ _KEVENT * NewAsyncReadRequestEvent;
	/*0118*/ _ASYNC_READ_THREAD_STATS * ReaderThreadsStats;
	/*0120*/ _LIST_ENTRY IdleAsyncLazywriteWorkerThreadList;
	/*0130*/ ULONG NumberActiveAsyncLazywriteWorkerThreads;
	/*0138*/ _LIST_ENTRY AsyncLazywriteWorkQueue;
	/*0148*/ _KEVENT NewAsyncLazywriteRequestEvent;
	/*0160*/ _ASYNC_LAZYWRITE_THREAD_STATS LazywriterThreadsStats;
	/*0190*/ _LIST_ENTRY IdleCompleteAsyncLazywriteWorkerThreadList;
	/*01a0*/ ULONG NumberActiveCompleteAsyncLazywriteWorkers;
	/*01a8*/ _LIST_ENTRY AsyncLazywriteCompletionWorkQueue;
	/*01b8*/
};
