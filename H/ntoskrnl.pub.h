...
struct SMKM_STORE<SM_TRAITS>
{
	...
	static char * SmStMapRegion(SMKM_STORE<SM_TRAITS> *,unsigned long,unsigned long,unsigned long,unsigned long);
	...
	static long SmStInSwapStore(SMKM_STORE<SM_TRAITS> *);
	...
	static void * SmStLockVirtualRegion(SMKM_STORE<SM_TRAITS> *,unsigned long,_SM_VIRTUAL_REGION *,void *,unsigned long);
...
struct SMKM_STORE_MGR<SM_TRAITS>
{
	...
	static void SmHighMemPriorityTimerStart(SMKM_STORE_MGR<SM_TRAITS> *);
